...
> Generated by: `python scripts/evidence-store.py --store evidence.json export`
...
- Evidence store: `evidence.json` (SHA-256 integrity: run `python scripts/evidence-store.py --store evidence.json verify`)
